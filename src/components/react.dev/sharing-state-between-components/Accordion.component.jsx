...
import TabButtonList from '../../components/TabButtonList.component';
const cities = [
	{
		city: 'London',
...
export default function Accordion() {
  ...
  return (
	...
	<Panel style={{color: 'green'}} title={cities[2].city} isActive={activeIndex === 2} onShow={() => setActiveIndex(2)}>{cities[2].content}</Panel>
